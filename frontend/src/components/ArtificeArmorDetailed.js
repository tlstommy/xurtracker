...
export default function ArtificeArmorDetailed(props) {
                                    ...
                                    <div className="artifice-perk ">
                                        ...
                                        <div className="flex py-2 items-start">
                                            ...
                                            <div className="flex items-start gap-3">
                                                <img className="w-14 lg:w-12 2xl:w-16 h-auto pt-1 self.start" alt="artifice perk" src={'https://www.bungie.net/common/destiny2_content/icons/46eec78bb7864641bbd7ba1fd4f9f248.png'} />
                                                <div>
                                                    <p className="font-semibold text-md lg:text-lg text-left text-white">Artifice Armor</p>
                                                    <p className="text-sm lg:text-md  text-left max-h-32 overflow-y-auto text-white">This armor contains a bonus socket that can be used to equip mods that allow you to slightly modify its stats.</p>
                                                </div>
                                            </div>
